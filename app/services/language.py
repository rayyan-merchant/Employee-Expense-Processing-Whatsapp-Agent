...
TEMPLATES = {
    ...
    "vendor_english_required": {
        "en": "🌐 I need the vendor name in English for our records.\nWhat's the English name for '{vendor}'?",
        "he": "🌐 אני צריך את שם הספק באנגלית לרישומים שלנו.\nמה השם באנגלית של '{vendor}'?",
    },
    "restart_fresh": {
...
CATEGORY_ALIASES = {
    ...
    "meals": "Meals", "meal": "Meals", "food": "Meals", "restaurant": "Meals", "lunch": "Meals", "dinner": "Meals", "coffee": "Meals", "cafe": "Meals",
    "travel": "Travel", "taxi": "Travel", "bus": "Travel", "transport": "Travel", "uber": "Travel", "gett": "Travel", "parking": "Travel",
    ...
    "ארוחות": "Meals", "ארוחה": "Meals", "אוכל": "Meals", "מסעדה": "Meals", "קפה": "Meals",
    "נסיעות": "Travel", "נסיעה": "Travel", "מונית": "Travel", "אובר": "Travel", "חניה": "Travel",
